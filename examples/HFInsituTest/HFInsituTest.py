...
bottomFluidChannel     = pyck.Cuboid(1,sum([0,0.027,0],CoShift),sum([0.045,0.040,0],CoShift));
topFluidChannel        = pyck.Cuboid(3,sum([0,0.064,0],CoShift),sum([0.045,0.078,0],CoShift));
fluid                  = pyck.Cuboid(2,sum([0,0.040,0],CoShift),sum([0.035,0.064,0],CoShift));
leftTopSolidBd         = pyck.Cuboid(4,sum([0.033,0.076,0],CoShift),sum([0.045,0.108,0],CoShift));
leftBottomSolidBd      = pyck.Cuboid(5,sum([0.033,0,0],CoShift),sum([0.045,0.027,0],CoShift));
solid                  = pyck.Cuboid(6,sum([0.045,0.002,0],CoShift),sum([0.195,0.102,0],CoShift));
waveMaker              = pyck.Cuboid(7,sum([0,0.04,0],CoShift),sum([0.002,0.064,0],CoShift));
solidTop               = pyck.Cuboid(8,sum([0.045,0.0900,0],CoShift),sum([0.1935,0.102,0],CoShift));
solidRightTop          = pyck.Cuboid(9,sum([0.18,0.0900,0],CoShift),sum([0.195,0.102,0],CoShift));
solidRightBottom       = pyck.Cuboid(10,sum([0.18,0.002,0],CoShift),sum([0.195,0.014,0],CoShift));
solidRight             = pyck.Cuboid(11,sum([0.18,0.014,0],CoShift),sum([0.195,0.09,0],CoShift));
solidBottom            = pyck.Cuboid(12,sum([0.045,0.002,0],CoShift),sum([0.1935,0.014,0],CoShift));
notch                  = pyck.TriPrism(0,sum([0.045,0.040,0],CoShift),sum([0.062,0.052,0],CoShift),sum([0.045,0.064,0],CoShift),0);
...
model.SetIntField(stateField,7,7);
...
model.Serialize("HFInsituTest_"+str(numParticles)+".vtp",writer);
