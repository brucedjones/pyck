...
model = pyck.Model([10.0,10.0,10.0,11.0,11.0,11.0,12.0,12.0,12.0],[3,3,3],3,3); # Create a model from points generated in python
model.AddPack(pack); # Add a pyck pack to an existing model
model.AddPack([13.0,13.0,13.0,14.0,14.0,14.0,15.0,15.0,15.0],[3,3,3],3,3); # Add points generated in python to an existing pack
